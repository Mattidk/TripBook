package dk.mathiaspedersen.tripbook.presentation.util.maps.map;
...
public final class Map {
     ...
     */
    public Map center(GeoPoint point) {
        this.center = point;
        return this;
    }
     ...
     * @return this instance
     */
    public Map center(double latitude, double longitude) {
     ...
     * @return this instance
     */
    public Map center(@Nonnull String address) {
     ...
     * @return this instance
     */
    public Map visible(GeoPoint geoPoint) {
     ...
     * @return this instance
     */
    public Map visible(String address) {
     ...
     * @return this instance
     */
    public Map visible(double latitude, double longitude) {
     ...
     * @return this instance
     */
    public Map visible(GeoPoint ...geoPoints) {
    ...
    /**
     * Add a style {@link Marker marker} with default {@link Marker.Style style}
     * @see #marker(GeoPoint...)
     * @return this instance
     */
     ...
     * @return this instance
     */
    public Map marker(double latitude, double longitude) {
     ...
     * @return this instance
     */
    public Map marker(String address) {
     ...
     * @return this instance
     */
    public Map marker(GeoPoint...markers) {
     ...
     * @return this instance
     */
    public Map marker(Marker.Style style, GeoPoint...markers) {
     ...
     * @return this instance
     */
    public Map path(Path.Style style, String points) {
     ...
     * @return this instance
     */
    public Map path(GeoPoint...points) {
        path(null, points);
        return this;
    }
     ...
     * @return this instance
     */
    public Map path(Path.Style style, GeoPoint...points) {
        path(new Path(style, points));
        return this;
    }
     ...
     * @return this instance
     */
    public Map size(int width, int height) {
        this.width = width;
        this.height = height;
        return this;
    }
    ...
    public String toString() {
        ...
        if(mapStyle != null) {
            builder.appendQuery("style", mapStyle);
        }
    ...
    static public class Path {
        ...
        public Path(@Nullable Style style, String encodedPoints) {
            if(encodedPoints == null || encodedPoints.length() == 0) throw new IllegalArgumentException("you must specify geopoints");
            this.style = style;
