package dk.mathiaspedersen.tripbook.presentation.util.staticmaps.map;
...
public final class StaticMap {
     ...
     * @return this instance
     */
    public StaticMap path(String points) {
        path(null, points);
        return this;
    }
     ...
     * @return this instance
     */
    public StaticMap path(Path.Style style, String points) {
